...
function crearcarta(datafunction){
    ...
    for(var i=0;i<datafunction.length;i++){
        var fechapasada = datos[i].date
        if (fecha<fechapasada)
    ...
    document.querySelector("#seccion-cartas-upcoming").innerHTML= templatehtml
}



function crearcheckbox(){
    var contcheck = document.getElementById("contenedor-checkbox-upcoming")
